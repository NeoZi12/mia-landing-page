...
function IconAnnualReports({ color = "#002069" }: { color?: string }) {
  return (
    <svg width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="1" y="1" width="16" height="20" rx="2" stroke={color} strokeWidth="1.5" />
      <path d="M5 6H13M5 10H13M5 14H9" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
      <path d="M19 5L23 9V21H19" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function FeaturedCard() {
  return (
    ...
    >
      ...
      {/* Content (above blobs) */}
      <div className="relative flex flex-col items-start w-full" style={{ gap: "clamp(6px, 0.8vh, 12px)", zIndex: 2 }}>
        {/* Icon badge */}
        <div
          className="flex items-center justify-center rounded-lg flex-shrink-0"
          style={{
        ...
        >
          זקוק לפתרון מורכב? נשמח לבחון את התיק הפיננסי שלך ולהציע את הדרכים היעילות ביותר לחיסכון במס המותאמות במדויק לפעילותך.
        </p>
...
export default function ServicesSection() {
  return (
    <section
      className="relative w-full bg-[#F7F9FB] flex flex-col items-center justify-center overflow-hidden md:h-screen isolate"
    >
